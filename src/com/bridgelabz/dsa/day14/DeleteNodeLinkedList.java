...
public class DeleteNodeLinkedList {
    ...
    public static class ListNode {
        ...
        public static void main(String[] args) {
            DeleteNodeLinkedList lists = new DeleteNodeLinkedList();
...
//            lists.pop(secondNode, lists);
        ...
        private static void search(DeleteNodeLinkedList lists, int data) {
    ...
    private void pop(ListNode node, DeleteNodeLinkedList lists) {
